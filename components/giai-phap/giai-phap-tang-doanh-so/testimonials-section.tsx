    ...
    <section className="relative py-24 bg-[#CCA776]/10 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <Badge className="bg-[#CCA776] text-white px-4 py-2 mb-6 shadow-md rounded-xl">📊 Đo lường & Phân tích hiệu quả</Badge>
          <h2 className="text-5xl lg:text-6xl font-extrabold text-black mb-6">
            Chúng tôi không nói suông. <span className="text-[#CCA776]">Chúng tôi nói bằng con số.</span>
          </h2>
