...
export function ProblemsSection() {
  return (
    <section className="relative py-20 bg-[#CCA776]/10 overflow-hidden">
      {/* Decorative Blobs */}
      <div className="absolute -top-24 -left-24 w-[350px] h-[350px] bg-[#CCA776] rounded-full blur-3xl opacity-50 animate-pulse" />
      <div className="absolute bottom-0 right-0 w-[300px] h-[200px] bg-[#CCA776] rounded-full blur-2xl opacity-40" />
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          <Badge className="bg-[#CCA776] text-white px-4 py-2 mb-6 shadow-md rounded-xl">❓ Tại sao các giải pháp thông thường thất bại?</Badge>
          ...
          <p className="text-xl text-black max-w-3xl mx-auto font-medium">
            ...
            <span className="text-[#CCA776]">Tại HLCC, chúng tôi tiếp cận doanh nghiệp của bạn như một "hiện trường" cần được điều tra để tìm ra "hung thủ" thật sự.</span>
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-10">
          {[{
            ...
            >
              <item.icon className="w-14 h-14 mx-auto mb-6 text-[#CCA776] group-hover:scale-110 transition-transform duration-300" />
