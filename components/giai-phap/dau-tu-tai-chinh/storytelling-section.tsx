      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <Quote className="w-12 h-12 text-[#CCA776] mx-auto mb-6" />
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <Card className="border-none shadow-xl bg-gradient-to-br from-red-50 to-pink-50">
              <CardContent className="p-8">
                ...
                <h3 className="text-xl font-bold text-black mb-4">Anh Minh - 34 tuổi, IT Manager</h3>
            ...
            <Card className="border-none shadow-xl bg-gradient-to-br from-green-50 to-emerald-50">
              <CardContent className="p-8">
                <div className="text-6xl mb-4">😌</div>
                <h3 className="text-xl font-bold text-black mb-4">Chị Hoa - 41 tuổi, Dược sĩ</h3>
                <p className="text-black leading-relaxed mb-4">
          ...
          <div className="text-center">
            <div className="bg-white rounded-3xl p-8 shadow-xl border border-[#CCA776] max-w-3xl mx-auto">
              <h3 className="text-2xl font-bold text-black mb-4">Sự khác biệt không phải ở TÀI NĂNG</h3>
              <p className="text-lg text-black leading-relaxed">
                Mà ở <span className="font-bold text-[#CCA776]">HỆ THỐNG</span> và
                <span className="font-bold text-[#CCA776]"> KỶ LUẬT</span>. Chúng tôi không dạy bạn làm giàu nhanh.
