    ...
    <section className="py-32 bg-gradient-to-b from-white to-amber-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <Quote className="w-16 h-16 text-amber-500 mx-auto mb-6" />
          ...
          {principles.map((principle, index) => (
            ...
            >
              <CardContent className="p-8">
                ...
                <blockquote className="text-lg text-gray-600 italic mb-4 border-l-4 border-amber-400 pl-4">
                  "{principle.quote}"
                </blockquote>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-amber-100 to-orange-100 rounded-3xl p-8 border border-amber-200 max-w-4xl mx-auto">
            <h3 className="text-3xl font-bold text-gray-800 mb-4">Đây không chỉ là lý thuyết</h3>
