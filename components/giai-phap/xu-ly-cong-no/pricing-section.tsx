      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Chi phí dịch vụ</h2>
            <p className="text-xl text-gray-600">Rõ ràng, minh bạch, không phí ẩn</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-white/80 rounded-2xl p-8 border border-yellow-200 text-center">
          ...
          <div className="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-2xl p-8 border border-yellow-200 text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Nguyên tắc làm việc của chúng tôi</h3>
