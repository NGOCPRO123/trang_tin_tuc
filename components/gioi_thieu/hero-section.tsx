...
export function HeroSection() {
  return (
    <section className="relative py-36 min-h-[500px] md:min-h-[650px] lg:min-h-[800px] overflow-hidden bg-cover bg-center" style={{backgroundImage: "url('https://i.pinimg.com/1200x/84/7e/77/847e77995f03d33f006c5975c9d56c65.jpg')"}}>
      {}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center w-full h-full mb-28">
        ...
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#CCA776] mt-2 mb-4 text-center max-w-7xl mx-auto tracking-wide font-sans drop-shadow font-black">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div className="bg-black/40 p-6 rounded-lg">
              <p className="text-lg md:text-xl text-white leading-relaxed">
                Hành trình của một chủ doanh nghiệp thường là một hành trình đơn độc. Chúng tôi thấu hiểu điều đó, bởi chính những nhà sáng lập <span className="font-black text-[#CCA776] drop-shadow">HLCC</span> cũng đã từng ở vị trí của bạn.
              </p>
            ...
            <p className="text-lg md:text-xl font-semibold text-white bg-black/40 p-6 rounded-lg border-l-4 border-[#CCA776]">
              <span className="text-[#CCA776] font-black drop-shadow">HLCC</span> ra đời không phải để trở thành một nhà cung cấp dịch vụ. Chúng tôi ra đời từ chính sự thấu hiểu đó, với một khát vọng trở thành người đồng hành chiến lược, một điểm tựa vững chắc cho các doanh nghiệp Việt.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center gap-3 text-white bg-black/40 p-4 rounded-lg shadow-sm">
              <Users className="w-5 h-5 text-[#CCA776] flex-shrink-0" />
              <span className="text-sm font-medium">Đội ngũ chuyên gia giàu kinh nghiệm</span>
            </div>
            <div className="flex items-center gap-3 text-white bg-black/40 p-4 rounded-lg shadow-sm">
              <Target className="w-5 h-5 text-[#CCA776] flex-shrink-0" />
              <span className="text-sm font-medium">Giải pháp thực chiến</span>
            </div>
            <div className="flex items-center gap-3 text-white bg-black/40 p-4 rounded-lg shadow-sm">
              <Award className="w-5 h-5 text-[#CCA776] flex-shrink-0" />
              <span className="text-sm font-medium">Cam kết kết quả</span>
            </div>
          </div>

          {/* Additional Information */}
          <div className="bg-black/40 p-6 rounded-xl border-2 border-[#CCA776] shadow-lg">
            <h3 className="text-xl font-bold text-[#CCA776] mb-4 flex items-center font-black drop-shadow">
              <Lightbulb className="mr-3 h-6 w-6 text-[#CCA776]" />
              Tại sao chọn HLCC?
            </h3>
            <div className="space-y-3 text-white">
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-[#CCA776] rounded-full flex-shrink-0"></div>
            ...
            <div className="relative w-full h-full rounded-3xl overflow-hidden border-2 border-[#CCA776] shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent flex items-end">
                <div className="p-8 text-white">
                  ...
                  <p className="text-[#CCA776] font-semibold drop-shadow">Sự kết hợp hoàn hảo giữa kinh nghiệm và đam mê</p>
                </div>
              </div>
            </div>
          </div>
