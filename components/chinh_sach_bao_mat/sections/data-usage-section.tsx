export default function DataUsageSection() {
  return (
    <section id="data-usage" className="bg-white/90 backdrop-blur-sm rounded-xl shadow-md p-8 border border-yellow-200">
      ...
      <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
        ...
        <div className="grid gap-6">
          <div className="bg-yellow-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Để cung cấp và duy trì dịch vụ:</h3>
          ...
          <div className="bg-amber-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Để cải thiện dịch vụ của chúng tôi:</h3>
            <ul className="space-y-2">
          ...
          <div className="bg-yellow-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Để liên lạc với bạn (với sự đồng ý của bạn):</h3>
            <p>
          ...
          <div className="bg-amber-50 rounded-lg p-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">Để đảm bảo an ninh và tuân thủ pháp luật:</h3>
            <ul className="space-y-2">
